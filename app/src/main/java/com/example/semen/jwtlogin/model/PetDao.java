 ...
 * DAO for table "PET".
*/
public class PetDao extends AbstractDao<Pet, Void> {
    ...
    public static class Properties {
        ...
        public final static Property UserId = new Property(3, Integer.class, "userId", false, "USER_ID");
    }
    ...
    public Pet readEntity(Cursor cursor, int offset) {
        Pet entity = new Pet( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getInt(offset + 3) // userId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Pet entity, int offset) {
        ...
        entity.setUserId(cursor.isNull(offset + 3) ? null : cursor.getInt(offset + 3));
     }
    
    @Override
    protected final Void updateKeyAfterInsert(Pet entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(Pet entity) {
        return null;
    }
